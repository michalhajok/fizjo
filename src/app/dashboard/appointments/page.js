...
// import { useAuth } from "@/hooks";
// import useApiFetch from "@/hooks/useApiFetch";
// import { getAppointments, updateAppointment, updateAppointmentStatus } from "@/lib/api";
...
//     // Można przełożyć wizyty które nie są już zakończone, anulowane lub nie odbyły się
//     return !["completed", "cancelled", "no-show"].includes(appointment.status);
//   };
...
//                 : getStatusColor(apt.status) === "purple"
//                 ? "bg-purple-100 text-purple-800"
//                 : getStatusColor(apt.status) === "orange"
